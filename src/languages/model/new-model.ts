export type GenericType = TupleType | MapType | SetType | SequenceType | OptionType | ResultType;
export type Id = string;
export type SequenceType = VoidType | { primitiveType: PrimitiveType } | EnumType | TypeWithStructure | NamedTypeReference;
export type Type = VoidType | { primitiveType: PrimitiveType } | EnumType | TypeWithStructure | NamedTypeReference;
...
export class MemberDeletion {
    constructor(
        public value: { name: Id } | NamedTypeReference
    ) {}
}
